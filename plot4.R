...
# Note 4: read.csv.sql filters the data with where condition, data for '1/2/2007' '2/2/2007' is loaded into fileData
 ...
 with(fileData,plot(fileData$DateTime,fileData$Global_active_power,type="l",ylab="Global Active Power",xlab=""))
 with(fileData,plot(fileData$DateTime,fileData$Voltage,type="l",ylab="Voltage",xlab="datetime"))
 ...
 with(fileData,plot(fileData$DateTime,fileData$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power"))
 dev.off()
